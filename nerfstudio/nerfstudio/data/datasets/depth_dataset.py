...
from nerfstudio.data.utils.data_utils import get_depth_or_uncertainty_image_from_path
...
class DepthDataset(InputDataset):
    ...
    def __init__(self, dataparser_outputs: DataparserOutputs, scale_factor: float = 1.0):
        ...
        if len(dataparser_outputs.image_filenames) > 0 and (
            ...
            if cache.exists():
                ...
                # ha! nerfstudio was using zoe depth from the beginning!
    ...
    def get_metadata(self, data: Dict) -> Dict:
        ...
        depth_image = get_depth_or_uncertainty_image_from_path(
