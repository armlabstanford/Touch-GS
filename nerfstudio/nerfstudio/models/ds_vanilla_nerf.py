...
"""
Implementation of depth supervised vanilla nerf.
"""
...
from nerfstudio.model_components.losses import MSELoss, DepthLossType, depth_loss, depth_ranking_loss
...
@dataclass
class DSVanillaModelConfig(VanillaModelConfig):
    """Depth Supervised Vanilla Model Config"""
