...
from nerfstudio.models.depth_gaussian_splatting import DepthGaussianSplattingModelConfig
...
method_configs["depth-gaussian-splatting"] = TrainerConfig(
    method_name="depth-gaussian-splatting",
    steps_per_eval_image=100,
    steps_per_eval_batch=0,
    steps_per_save=2000,
    steps_per_eval_all_images=1000,
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=DepthGaussianSplattingModelConfig(),
    ),
    optimizers={
        "xyz": {
            "optimizer": AdamOptimizerConfig(lr=1.6e-4, eps=1e-15),
