...
/////// async policy
    ...
    message_filters::Subscriber<geometry_msgs::PoseStamped> sub_pose_obj_;
    message_filters::Subscriber<geometry_msgs::PoseStamped> sub_pose_cam_;
    ...
    typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, 
                                                            ...
                                                            geometry_msgs::PoseStamped> cap_syncPolicy;
