...
python3 utils/add_depth_file_path_to_transforms.py --base_repo_path 'touch-gs-data/bunny_blender_data' --filename 'transforms.json' --depth_file_path_template 'fused_output_dir' --uncertainty_file_path_template 'fused_output_dir_uncertainty'
...
python3 utils/create_point_cloud_from_touches.py --root_dir 'touch-gs-data/bunny_blender_data' --touch_depth_dir 'touch_depth' --touch_var_dir 'touch_var' --image_dir 'imgs' --transform_json_path 'transforms.json' --train_split 0.13
