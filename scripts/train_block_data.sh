...
ns-train depth-gaussian-splatting --data block_data/ --viewer.quit-on-train-completion True --pipeline.model.depth-loss-mult 0.2 --pipeline.model.depth-loss-type DEPTH_UNCERTAINTY_WEIGHTED_LOSS  --pipeline.model.uncertainty_weight 1 nerfstudio-data --train-split-fraction 0.8
