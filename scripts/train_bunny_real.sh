...
python3 ../experiment_utils/run_eval.py --input_dir outputs/bunny_real_data/depth-gaussian-splatting --output_dir ../experiments --exp_name bunny_real_exp --past_n_trials 1
